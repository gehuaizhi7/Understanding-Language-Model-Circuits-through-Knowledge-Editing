...
def main(args):
    ...
    for epoch in range(args['train_epochs']):
        ...
        #     save_dir = os.path.join(args['model_dir'], f"mask_logits/{args['task_name']}")
        #     if not os.path.exists(save_dir):
        #         os.makedirs(save_dir)
        #     save_fn = os.path.join(save_dir, f"{args['model_name']}-{epoch}.pt")
        #     masked_model.save_mask_logits(save_fn)
    ...
    # Save the masks
    file_path = os.path.join('./output', f"{args['task_name']}_masks.json")
...
#     )
    ...
    file_path = os.path.join('./output', f"{args['task_name']}_editing_results.json")
    os.makedirs(os.path.dirname(file_path), exist_ok=True)
    with open(file_path, 'w') as f:
...
#test the complementary model
    ...
    file_path = os.path.join('./output', f"{args['task_name']}_editing_results_complementary.json")
    os.makedirs(os.path.dirname(file_path), exist_ok=True)
    with open(file_path, 'w') as f:
